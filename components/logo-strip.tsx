 ...
 *
 * The names are the five most recognizable clubs Filipa has worked with. The
 * marks are generic inline SVGs (not official emblems) to avoid trademark issues
 * — swap for real logos only with permission (drop SVGs into public/img/logos
